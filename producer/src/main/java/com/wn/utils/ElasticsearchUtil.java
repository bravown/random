...
import com.wn.anntation.Document;
import com.wn.anntation.EsId;
...
public class ElasticsearchUtil {
    ...
    public XContentBuilder generateBuilder(Class clazz) throws IOException {
        ...
        for (Field f : declaredFields) {
            if (f.isAnnotationPresent(com.wn.anntation.Field.class)) {
                // 获取注解
                com.wn.anntation.Field  declaredAnnotation = f.getDeclaredAnnotation(com.wn.anntation.Field.class);
                ...
                if (declaredAnnotation.type() == FieldType.OBJECT) {
                    ...
                    // 遍历该对象中的所有属性
                    for (Field f2 : df2) {
                        if (f2.isAnnotationPresent(com.wn.anntation.Field.class)) {
                            // 获取注解
                            com.wn.anntation.Field declaredAnnotation2 = f2.getDeclaredAnnotation(com.wn.anntation.Field.class);
