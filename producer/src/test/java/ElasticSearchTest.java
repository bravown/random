...
//    @Test
//    public void updateIndex(Class clazz) throws Exception {
//        ParseContext.Document declaredAnnotation = (ParseContext.Document) clazz.getDeclaredAnnotation(ParseContext.Document.class);
...
//    }
    ...
    public void add() throws IOException {
        String indexName = "person";
        User user = new User(12L,"张",123);
        Team team = new Team(12L,"海尔","青岛");
        IndexRequest request = new IndexRequest(indexName);
        String userJson = JSON.toJSONString(user);
        String teamJson = JSON.toJSONString(team);
        request.source(userJson, XContentType.JSON);
        request.source(teamJson, XContentType.JSON);
        System.out.println(restHighLevelClient.index(request, RequestOptions.DEFAULT));
    }
